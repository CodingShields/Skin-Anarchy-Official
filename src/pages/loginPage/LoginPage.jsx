	...
	return (
		<div className='w-full h-fit bg-black animate-fadeIn'>
			...
			<div
				className={
					!loginModal
						? "animate-fadeIn w-full mx-auto h-full z-10 relative py-64 border-b-2 border-white"
						: "animate-fadeOut w-full mx-auto h-full z-10 relative py-48 border-b-2 border-white"
				}
			>
			...
			<div className='w-full h-full text-white text-3xl font-montserrat font-thin uppercase tracking-widest text-center pt-32 pb-32'>
