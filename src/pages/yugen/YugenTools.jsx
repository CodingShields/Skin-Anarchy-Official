...
const YugenTools = ({ handleMagToggle }) => {
	...
	return (
		<div className='flex h-full relative mt-96 pl-4 animate-fadeIn'>
			<div className='flex flex-col border-2 bg-black/50 border-white rounded-2xl h-64 p-4 space-y-4 justify-center items-center'>
