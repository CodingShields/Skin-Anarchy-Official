...
import { findCurrentUser } from "../../utilities/utilities";
...
const WelcomePage = () => {
	...
	return (
		<div className='w-full h-fit flex justify-center items-center bg-black animate-fadeIn'>
			<div className='w-1/2 h-fit bg-black text-white flex justify-start items-center flex-col rounded-full z-10 pb-24'>
				...
				<div className='py-96 z-50 mt-20'>
					...
					<p className='w-10/12 text-4xl  mx-auto mt-4 font-montserrat font-thin text-left leading-[64px] mr-2'>
						If you have questions, send a message through our &quot;Connect&quot; tab, or click the chat icon in the bottom right hand corner of your
						screen.
					</p>
				...
				<Button text='Homepage' onClick={() => navigate("/members-area/home")} style={buttonStyle} />
			</div>
		</div>
	);
};
