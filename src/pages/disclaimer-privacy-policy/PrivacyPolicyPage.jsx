...
const PrivacyPolicyPage = () => {
	...
	return (
		<div className='w-full h-fit text-white bg-black font-thin'>
			<div className='w-3/4 h-fit flex flex-col justify-center items-center mx-auto py-24'>
				...
				<div className='w-[1000px] border-[.5px] border-white px-14'>
					<ol className=' text-white mx-auto list-decimal	 py-12'>
						<li className='text-2xl tracking-widest font-normal pb-2 '>Introduction</li>
						...
						<li className='text-2xl tracking-widest font-normal pb-4'>
							<h1>Information We Collect</h1>{" "}
						</li>
						<div className='w-10/12 mx-auto pb-8'>
							<ul className=' text-white mx-auto list-disc space-y-2 '>
								<li className='text-xl tracking-widest font-normal '>Personal Information:</li>
								...
								<li className='text-xl tracking-widest font-normal'> Usage Data:</li>
								<p className='text-lg ml-6 text-start pb-2 tracking-widest'>
									We track clicks, page views, and other interactions on our website to improve our services.
								</p>
								<li className='text-xl tracking-widest font-normal'>Cookies: </li>
								<p className='text-lg ml-6 text-start pb-2 tracking-widest'>
								...
								<li className='text-xl tracking-widest font-normal'>Transaction Data:</li>
								<p className='text-lg ml-6 text-start pb-2 tracking-widest'>
						...
						<div className='w-10/12 mx-auto pb-8'>
							<ul className=' text-white mx-auto list-disc space-y-2 '>
								<li className='text-xl tracking-widest font-normal'>Account Management:</li>
