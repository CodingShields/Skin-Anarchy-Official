...
import { getFirestore, collection, getDocs, getDoc, setDoc, updateDoc, doc } from "firebase/firestore";
	...
	return (
		<div className='block items-center justify-center w-full h-full '>
			<div className='flex flex-col items-center justify-center w-fit h-full mt-8'>
				...
				<div className='flex flex-row justify-evenly items-center w-fit h-fit mt-8 space-x-10'>
					<div className='flex flex-col justify-center items-center w-72 h-fit text-lg'>
						<h1 className='font-bold text-xl text-center mb-2'>User Stats</h1>
						<div className='w-72 h-fit border-2 border-black text-lg'>
							<h1 className='font-bold'>Active Subs:</h1>
						</div>
						<div className='w-72 h-fit border-2 border-black mt-8 text-lg'>
				...
				<div className='w-11/12 h-fit flex flex-row justify-start items-end text-center text-lg mb-4 ml-32'>
				...
				<div className='flex w-fit h-full justify-center items-start '>
					<div className=' w-11/12 h-3/4 border-2 border-black'>
						<div className='grid grid-cols-11 gap-x-3 my-2 border-b-2 border-black font-bold text-center'>
							...
							<h1 className='cursor-pointer hover:text-blue-500'>Delete User</h1>
						</div>
						{users.map((user, id) => (
							<div key={id} className='grid grid-cols-11 gap-x-3 gap-y-2 border-b-2 place-items-center border-black font-bold text-center '>
								<h1>
