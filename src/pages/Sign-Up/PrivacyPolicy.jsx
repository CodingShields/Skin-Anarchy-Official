...
const PrivacyPolicy = ({ close, open }) => {
	if(!open) return null
	return (
		<div className={`w-full h-screen text-white py-12  bg-black z-20  animate-fadeIn overflow-y-scroll`}>
			<div className='w-3/4 h-fit flex flex-col justify-center items-center mx-auto '>
				...
				<div className='w-[1000px] border-[.5px] border-white px-14'>
					<ol className=' text-white mx-auto list-decimal	 py-12'>
						...
						<p className='text-sm ml-6 text-start pb-8 tracking-widest'>
						...
						<div className='w-10/12 mx-auto pb-8'>
							<ul className=' text-white mx-auto list-disc space-y-2 '>
								<li className='text-sm tracking-widest font-normal '>Personal Information:</li>
								<p className='text-sm ml-6 text-start pb-2 tracking-widest'>
								...
								<li className='text-sm tracking-widest font-normal'> Usage Data:</li>
								<p className='text-sm ml-6 text-start pb-2 tracking-widest'>
									We track clicks, page views, and other interactions on our website to improve our services.
								</p>
								<li className='text-sm tracking-widest font-normal'>Cookies: </li>
								<p className='text-sm ml-6 text-start pb-2 tracking-widest'>
								...
								<li className='text-sm tracking-widest font-normal'>Transaction Data:</li>
								<p className='text-sm ml-6 text-start pb-2 tracking-widest'>
						...
						<div className='w-10/12 mx-auto pb-8'>
							<ul className=' text-white mx-auto list-disc space-y-2 '>
								<li className='text-sm tracking-widest font-normal'>Account Management:</li>
								<p className='text-sm ml-6 text-start pb-2 tracking-widest'>To manage your account and provide you with personalized services.</p>
								<li className='text-sm tracking-widest font-normal'>Order Fulfillment:</li>{" "}
								<p className='text-sm ml-6 text-start pb-2 tracking-widest'>
									To process and fulfill your orders, including shipping, returns, and customer service.
								</p>
								<li className='text-sm tracking-widest font-normal'>Marketing: </li>{" "}
								<p className='text-sm ml-6 text-start pb-2 tracking-widest'>
									To send you promotional offers, newsletters, and other relevant information if you opt-in to receive them.
								</p>
								<li className='text-sm tracking-widest font-normal'>Security:</li>{" "}
								<p className='text-sm ml-6 text-start pb-2 tracking-widest'>
