const SignatureBar = () => {
	return (
		<div className='flex flex-col justify-center items-center h-fit w-full py-36 relative '>
			<div className='w-3/4 py-6 mt-4'>
				...
				<div className='flex flex-row justify-center items-center w-full h-fit py-6 space-x-4'>
