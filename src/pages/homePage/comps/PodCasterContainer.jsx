...
const PodCastContainer = () => {
	return (
		<div className=" flex flex-row w-full justify-evenly h-full bg-black pb-20 lg:py-24 py-16">
			...
			<div className=" w-fit h-fit ml-4 mb-4 lg:ml-14 mt-20 rounded-3xl p-2 z-10">
				<div className="flex flex-col w-[700px] h-full px-12  text-2xl   text-white ">
					<h1 className="mb-6 text-4xl  text-center lg:text-4xl font-playfair">
						Where To Find Us
					</h1>
					<div className="flex flex-col justify-center items-center text-center h-full w-full pt-4 text-md space-y-8 font-glacialRegular">
						<p className="mb-6 text-center w-full lg:text-xl ">
							We started our journey with Anchor FM and have expanded onto over
							12 major podcast platforms.
						</p>
						<p className="mb-6 text-center lg:text-xl font-glacialRegular">
							Knowledge is meaningless without proper accessibility and
							therefore all of our episodes are available anywhere you can
							stream a podcast and are all available as open access, full length
							interviews with the leaders in the skin health and beauty space.
						</p>
						<p className="mb-6 text-center lg:text-xl font-glacialRegular">
							The Skin Anarchy podcast is available on all major platforms
							including Apple Podcasts, Spotify, Google Podcasts, and many more.
						</p>
					</div>
