	...
	const [testimonials] = useState([
		{
			...
			lineTwo: "Love listening to this show. It brings such stimulating and authentic reflections. Thank you Dr. Ekta",
	...
	return (
		<div className='w-full h-[1500px] sm:h-fit relative  z-10'>
			<div className='flex flex-col items-center px-6 mx-auto '>
				<h1 className='text-[120px] sm:text-3xl font-thin tracking-widest uppercase text-center text-white py-36 sm:py-16 font-montserrat  whitespace-nowrap'>
					THE Skin Authority
				</h1>
			</div>
			<div className='w-full h-fit flex flex-row'>
				<div className='w-3/4 sm:w-full line mx-auto sm:pb-12'>
					<blockquote className='  text-white  '>
						<figure className='relative pt-6 isolate sm:pt-12 opacity-20  ml-12'>
							<svg viewBox='0 0 162 128' fill='none' aria-hidden='hidden' className='absolute top-0 left-0 h-32 -z-10 stroke-zinc-100'>
								<path
						...
						<p className=' sm:text-xl text-5xl font-montserrat uppercase sm:indent-0 indent-8 text-center'>{testimonials[testimonialIndex].lineOne}</p>
					</blockquote>
					<figcaption className='mt-8 sm:mt-4'>
						<div className=' sm:w-3/4 sm:text-center sm:mx-auto sm:text-wrap font-thin text-white sm:text-[18px] text-2xl font-montserrat sm:leading-[40px]leading-[60px] py-4'>
							{'"' + testimonials[testimonialIndex].lineTwo + '"'}
						</div>
						<div className='mt-1 font-light  text-white py-4 sm:text-lg font-montserrat indent-14'>{testimonials[testimonialIndex].lineThree}</div>
					</figcaption>
				</div>
			</div>
		</div>
