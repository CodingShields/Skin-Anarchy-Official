		...
		<div className='flex flex-col justify-center items-center text-center h-full w-full relative pt-10 transform-gpu'>
			...
			<div className='absolute flex flex-col h-full w-full p-4 mb-8 text-5xl font-bold text-center text-white z-10 top-1/4'>
				...
				<div className='flex flex-row h-fit justify-evenly mt-32'>
					<div className='flex flex-col w-96 h-96  bg-black rounded-lg shadow-2xl justify-center items-center bg-opacity-80 shadow-violet-700 ring-4 ring-violet-700 '>
					...
					<div className='flex flex-col w-96  h-96  bg-black rounded-lg shadow-2xl justify-center items-center  bg-opacity-20  shadow-violet-700 ring-4 ring-violet-700 '>
						<h3 className='mt-1 text-4xl font-semibold text-violet-500 mb-4'>
					...
					<div className='flex flex-col w-96 h-96 px-2 py-2  bg-black rounded-lg shadow-2xl justify-center items-center  bg-opacity-20 shadow-violet-700 ring-4 ring-violet-700 '>
						<h3 className='mt-1 text-4xl font-semibold text-violet-500 mb-4'>
					...
					<div className='flex flex-col h-96  w-96 px-2 py-2  bg-black rounded-lg shadow-2xl justify-center items-center  bg-opacity-20 shadow-violet-700 ring-4 ring-violet-700 '>
						<h3 className='mt-1 text-4xl font-semibold text-violet-500 mb-4'>
