...
const SponsorBarContainer = () => {
	...
	return (
		<div
		className="flex flex-col items-center justify-center w-full py-16 bg-gray-100 h-fit"
		>
			<h1 className='text-4xl font-bold text-center text-black'>Take a Look At Our Sponsors</h1>
