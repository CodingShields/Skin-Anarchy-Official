...
const NewsLetterContainer = () => {
  return (
		<div className='w-full h-full bg-gradient-to-b from-white to-black py-48'>
			<div className='grid grid-cols-1 gap-10 px-6 mx-auto max-w-7xl lg:grid-cols-12 '>
				...
				<form className='w-full max-w-md lg:col-span-5 lg:pt-2'>
					<div className='flex gap-x-4'>
						...
						<button
							type='submit'
							className='font-glacialRegular flex-none rounded-md bg-black px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-gold-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold-500 transition-all ease-in-out duration-500 hover:text-black hover:shadow-xl hover:shadow-black'
						>
							Subscribe
						</button>
					</div>
					<p className='mt-4 text-sm leading-6 text-gray-200 font-glacialRegular font-thin'>
						...
						<a href='#' className='text-white font-glacialRegular font-thin hover:text-gold-500'>
							privacy&nbsp;policy
						</a>
						.
					</p>
