	...
	return (
		<div className='w-full min-h-screen py-12 animate-fadeIn'>
			<div className='w-10/12 h-full flex flex-row justify-center items-start font-montserrat text-white mt-36 mx-auto'>
                <div
                    className='w-3/4 h-fit mx-auto border-l border-b rounded-bl-2xl pl-16 pb-16 pt-24'>
					<h1 className='text-5xl'>About S.A.F.E Seal</h1>
					<p className='py-4 text-3xl ml-2 indent-6 mt-2 text-justify'>
					...
					<p className='py-4 text-3xl ml-2 indent-6 text-justify'>
					...
					<p className='py-4 text-2xl text-justify mb-4'>
				...
				<div className='w-1/2 h-fit flex flex-col justify-start  items-center'>
